...
dummy_columns = [pretty_midi.note_number_to_name(n) for n in range(0, 128)]
...
class Preprocessing:
    ...
    def write_one_instrument_into_csv(self, instrument, _song_name, _semi_shift, _sampling_freq, i, j):
        ...
        if instrument.program == 0 and 'piano' in instrument.name.lower():
            ...
            try:
                _df = encode_dummies(instrument, _sampling_freq, dummy_columns).fillna(value=0)  # fill invalid values
    ...
    def write_one_track_into_csv(self, i, file):
        ...
        try:
            ...
            print("_sampling_freq", _sampling_freq)
