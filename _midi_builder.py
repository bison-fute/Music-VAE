...
class MidiBuilder():
    ...
    def __init__(self, midi_start=48, midi_end=108):
        """ midi_start (int): The first midi note in the dataset ; midi_end (int): The last midi note in the dataset """
    ...
    def midi_from_piano_roll(self, sample, tempo=120, program=0):
        ...
        for idx in piano_roll.index:
            for note_name in piano_roll.columns:
                ...
                if piano_roll.iloc[idx][note_name] == 1.:
                    ...
                    # TODO: Smooth this a bit by using lookaheadmodel-and-training.ipynb
